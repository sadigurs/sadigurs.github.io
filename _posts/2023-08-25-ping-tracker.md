...
I decided to extend and host the dashboard on PythonAnywhere so I could access it anytime. You can check it out [here](../_layouts/pings_online.html). It's far from being a masterpiece, but it does the job 😊. 
